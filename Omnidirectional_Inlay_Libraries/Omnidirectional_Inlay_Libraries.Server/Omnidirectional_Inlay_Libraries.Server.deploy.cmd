...
set _DeploySetParametersFile=%RootPath%Omnidirectional_Inlay_Libraries.Server.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Omnidirectional_Inlay_Libraries.Server.zip" (
echo "%RootPath%Omnidirectional_Inlay_Libraries.Server.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Omnidirectional_Inlay_Libraries.Server.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Omnidirectional_Inlay_Libraries.Server.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Omnidirectional_Inlay_Libraries.Server.deploy-readme.txt" (
...
start notepad "%RootPath%Omnidirectional_Inlay_Libraries.Server.deploy-readme.txt"
)
echo =========================================================
goto :eof
